...
export const metadata: Metadata = {
  title: "Case Converter — freeq.one",
  description: "Convert text between camelCase, snake_case, kebab-case, PascalCase, Title Case, UPPER CASE, lower case, and more. Part of the freeq.one tools suite.",
};
